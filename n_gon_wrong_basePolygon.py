""" This file contans the wrong instantiation of base polygons that don't satisfy the constraint of pi/k, namely,
angles are not integer factor of pi. So, the dirichlet domain won't be calculated correctly.
"""
