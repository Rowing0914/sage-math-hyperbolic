...
# n1, n2, n3, n4 = 4, 4, 4, 4
n1, n2, n3, n4 = 3, 4, 5, 6
# given angles, we draw a hyperbolic triangle with these angles
# a1, a2, a3, a4 = pi / n1, pi / n2, pi / n3, pi / n4
a1, a2, a3, a4 = pi / n1, pi / n2, pi / n3, pi / n4
# a1, a2, a3, a4 = (2*pi) / n1, (2*pi) / n2, pi / n3, pi / n4
N = 2 * lcm([n1, n2, n3])
...
Q1, Q2, Q3 = CC(Q1), CC(Q2), CC(Q3)
Q4 = CC(-(Q3).conjugate())
pts = [Q1, Q3, Q2, Q4]  # Reorder points to instantiate the polygon to visualise
p1, p2, p3 = P1.coordinates(), P2.coordinates(), P3.coordinates()

l1 = UHP.get_geodesic(Q1, Q2)
l2 = UHP.get_geodesic(Q2, Q3)
l3 = UHP.get_geodesic(Q3, Q4)
l4 = UHP.get_geodesic(Q4, Q1)

_a1, _a2, _a3, _a4 = np.rad2deg(float(l1.angle(l2))), np.rad2deg(float(l2.angle(l3))), np.rad2deg(
    float(l3.angle(l4))), np.rad2deg(float(l4.angle(l1)))
a1, a2, a3, a4 = np.rad2deg(float(a1)), np.rad2deg(float(a2)), np.rad2deg(float(a3)), np.rad2deg(float(a4))
print("Target Angles: ", round(a1, ndigits=2), round(a2, ndigits=2), round(a3, ndigits=2), round(a4, ndigits=2))
print("Angles: ", round(_a1, ndigits=2), round(_a2, ndigits=2), round(_a3, ndigits=2), round(_a4, ndigits=2))

p = hyperbolic_polygon(pts=pts, model="UHP", fill=True, alpha=0.3)
# p = hyperbolic_polygon(pts=pts, model="PD", fill=True, alpha=0.3)
